        ...
        <div className="flex justify-between p-2 md:ml-6 md:mr-6 relative">
            ...
            <div className="flex">
                ...
                <TooltipComponent content="Notification" position="BottomCenter">
                    ...
                    >
                        <span style={{ background: 'rgb(254, 201, 15)' }} className="absolute inline-flex rounded-full h-2 w-2 right-2 top-2" />
                        <RiNotification3Line />
                    </button>
                </TooltipComponent>
                <TooltipComponent content="Profile" position="BottomCenter">
                    ...
                    >
                        ...
                        />
                        <p>
                            <span className="text-gray-400 text-14">Hi,</span> <span className="text-gray-400 font-bold ml-1 text-14">Dinh Lan</span>
                        </p>
